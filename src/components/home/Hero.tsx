          ...
          <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-zen-blue-500 xl:inline">Made Simple</span>
              </h1>
              ...
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                <div className="rounded-md shadow">
                  <Link to="/buy">
                    <Button className="flex w-full items-center justify-center rounded-md px-8 py-3 text-base font-medium bg-zen-blue-500 hover:bg-zen-blue-600">
                      Find a Home
                    </Button>
                  </Link>
                </div>
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link to="/sell">
                    <Button
                      variant="outline"
                      className="flex w-full items-center justify-center rounded-md px-8 py-3 text-base font-medium border-zen-blue-500 text-zen-blue-500 hover:bg-blue-50"
                    >
                      Sell Your Property
                    </Button>
                  </Link>
