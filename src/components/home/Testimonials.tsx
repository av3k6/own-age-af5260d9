...
const Testimonials = () => {
  return (
    <section className="py-12 bg-zen-blue-500 dark:bg-zen-blue-700 text-white transition-colors duration-300">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white dark:bg-blue-800 rounded-lg p-6 shadow-lg text-zen-gray-800 dark:text-white transition-colors duration-300"
            >
              <div className="mb-4">
                <svg width="45" height="36" className="text-zen-blue-200 dark:text-zen-blue-400 mb-4" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
