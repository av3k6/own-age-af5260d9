...
const Testimonials = () => {
  return (
    <section className="py-12 bg-zen-blue-500 text-white">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index} 
              className="bg-white rounded-lg p-6 shadow-lg text-zen-gray-800"
            >
              <div className="mb-4">
                <svg width="45" height="36" className="text-zen-blue-200 mb-4" viewBox="0 0 45 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-zen-gray-600">{testimonial.role}</p>
                  </div>
                </div>
              </div>
            </div>
